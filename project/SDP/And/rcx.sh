#!/bin/ksh
# This script was generated Fri Feb 20 22:23:53 2026 by:
#
...
#	/home/buet/Desktop/SDP/And.xcn -assura_run_dir \
#	/home/buet/Desktop/SDP/ -assura_run_name And -rcxdir \
#	/home/buet/Desktop/SDP/And -xy_coordinates c,r -type full \
...
#	/home/buet/Desktop/SDP/And/extview.tmp -net_name_space layout -minR \
...
##NETS_FILE=/dev/null
##OUTPUT=/home/buet/Desktop/SDP/And/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/buet/Desktop/SDP/And
##RCXFS_HIGH=N
...
vdbToRcx /home/buet/Desktop/SDP And -unit meters -- -V1 -H satfile -r \
	/home/buet/Desktop/SDP/And.xcn -df2 -xgl
...
advgen -V -g0 -li -f -n -o HSPICE -h ${HIERARCHY_DELIMITER} -TL L1T0 -cgnd \
	...
	_pmos_12_MOS_7.transr - NET - /home/buet/Desktop/SDP/And/extview.tmp
