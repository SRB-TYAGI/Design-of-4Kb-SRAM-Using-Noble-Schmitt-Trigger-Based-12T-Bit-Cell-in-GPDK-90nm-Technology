#!/bin/ksh
# This script was generated Sat Feb 21 12:23:59 2026 by:
#
...
#	/home/buet/Desktop/SDP/Decoder_3_8.xcn -assura_run_dir \
#	/home/buet/Desktop/SDP/ -assura_run_name Decoder_3_8 -rcxdir \
#	/home/buet/Desktop/SDP/Decoder_3_8 -xy_coordinates c,r -type full \
...
#	/home/buet/Desktop/SDP/Decoder_3_8/extview.tmp -net_name_space layout \
...
##AGDS_TEXT_LAYERS=
##ARRAY_VIAS_SPACING=
##ASSURA_RUN_DIR=/home/buet/Desktop/SDP
##ASSURA_RUN_NAME=Decoder_3_8
...
##NETS_FILE=/dev/null
##OUTPUT=/home/buet/Desktop/SDP/Decoder_3_8/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/buet/Desktop/SDP/Decoder_3_8
##RCXFS_HIGH=N
...
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
cd /home/buet/Desktop/SDP/Decoder_3_8
...
/home/buet/Desktop/SDP/Decoder_3_8.xcn
ENDCAT
...
vdbToRcx /home/buet/Desktop/SDP Decoder_3_8 -unit meters -- -V1 -H satfile -r \
	/home/buet/Desktop/SDP/Decoder_3_8.xcn -df2 -xgl
...
pax16 -V -scf sip.cmd -cgnd ${CAP_GROUND},1.0 -rP \
	np_rmetal2_conn.res,np_rmetal1_conn.res,np_rpoly_conn.res,mwires.res \
	-M_perim_off -c \
	...
	allGate - /home/buet/cadence/gpdk090_v4.6/assura/rcx/paxfile_coeff - \
	- NET - capfile
...
advgen -V -g0 -li -f -n -o HSPICE -h ${HIERARCHY_DELIMITER} -TL L1T0 -cgnd \
	...
	/home/buet/Desktop/SDP/Decoder_3_8/extview.tmp
