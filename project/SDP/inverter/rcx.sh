#!/bin/ksh
# This script was generated Fri Feb 20 22:43:02 2026 by:
#
...
#	/home/buet/Desktop/SDP/inverter.xcn -assura_run_dir \
#	/home/buet/Desktop/SDP/ -assura_run_name inverter -rcxdir \
#	/home/buet/Desktop/SDP/inverter -xy_coordinates c,r -type full \
...
#	/home/buet/Desktop/SDP/inverter/extview.tmp -net_name_space layout \
...
##NETS_FILE=/dev/null
##OUTPUT=/home/buet/Desktop/SDP/inverter/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/buet/Desktop/SDP/inverter
##RCXFS_HIGH=N
...
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
cd /home/buet/Desktop/SDP/inverter
...
/home/buet/Desktop/SDP/inverter.xcn
ENDCAT
...
vdbToRcx /home/buet/Desktop/SDP inverter -unit meters -- -V1 -H satfile -r \
	/home/buet/Desktop/SDP/inverter.xcn -df2 -xgl
...
advgen -V -g0 -li -f -n -o HSPICE -h ${HIERARCHY_DELIMITER} -TL L1T0 -cgnd \
	...
	/home/buet/Desktop/SDP/inverter/extview.tmp
